package net.zentring.live.download;
...
public final class DownloadManager {
    ...
    public synchronized MyDownLoadHolder startDownload(String url, String label, String savePath,
                                                       boolean autoResume, boolean autoRename,
                                                       MyDownLoadHolder viewHolder) throws DbException {
        ...
        if (downloadInfo != null) {
            ...
            if (callback != null) {
                if (viewHolder == null) {
                    viewHolder = new MyDownLoadHolder(null, downloadInfo);
                }
    ...
    public static class MyDownLoadHolder extends DownloadViewHolder {

        public MyDownLoadHolder(View view, DownloadInfo downloadInfo) {
        ...
        public void onSuccess(File result) {
            if (onDoneListener != null) {
                onDoneListener.onDone(Common.DOWN_LOAD_GRAPHIC_STATUS.success.toNumber());
            }
        }
        ...
        public void onError(Throwable ex, boolean isOnCallback) {
            if (onDoneListener != null) {
                onDoneListener.onDone(Common.DOWN_LOAD_GRAPHIC_STATUS.error.toNumber());
            }
        }
        ...
        public void onCancelled(Callback.CancelledException cex) {
            if (onDoneListener != null) {
                onDoneListener.onDone(Common.DOWN_LOAD_GRAPHIC_STATUS.cancel.toNumber());
            }
        }

        private OnDoneListener onDoneListener;

        public void onSuccessListener(OnDoneListener listener) {
