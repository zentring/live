package net.zentring.live.CustomLoadingView;
...
public class ShapeLoadingView extends View {
    ...
    private void init(Context context) {
        mTriangleColor = getColor(context, R.color.alert_pink_dark);
        mCircleColor = getColor(context, R.color.alert_violet_dark);
        mRectColor = getColor(context, R.color.my_yellow_dark);
        mPaint = new Paint();
